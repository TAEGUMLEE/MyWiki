...
```markdown
![대체 텍스트(alternative text)를 입력하세요!](https://www.shutterstock.com/image-photo/view-valley-castle-hohenschwangau-103574675 "링크 설명(title)을 작성하세요.")

![Winter][logo]

[logo]: https://www.shutterstock.com/image-photo/torres-del-paine-national-park-chile-143573395 "Winter."
```
